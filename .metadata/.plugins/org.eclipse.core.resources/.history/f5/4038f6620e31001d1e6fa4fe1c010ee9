...
public class Pessoa {
	...
	public Pessoa(Builder build) {
		super();
		this.nome = build.nome;
		this.cargo = build.cargo;
		this.dataNascimento = build.dataNascimento;
		this.dataAdmissao = build.dataAdmissao;
		this.idade = build.idade;
		this.salarioBruto = build.salarioBruto;
		this.salarioLiquido = build.salarioLiquido;
	}
